    ...
    return (
      <div styleName="root">
        ...
        <ul styleName="list">
          ...
          <li>
            <a
              href="https://boostnote.paintory.com/"
              onClick={e => this.handleLinkClick(e)}
            >
              Boostnote Shop
            </a>{' '}
            : Products are shipped to all over the world 🌏
          </li>
          <li>
            <a
              href="https://salt.bountysource.com/teams/boostnote"
              onClick={e => this.handleLinkClick(e)}
            >
              Donate via Bountysource
            </a>{' '}
          ...
          <li>
            ...
            : Development configurations for Boostnote 🚀
          </li>
          <li styleName="cc">Copyright (C) 2017 Maisin&Co.</li>
          <li styleName="cc">License: GPL v3</li>
        </ul>
        <hr />
        <div styleName="policy">Data collection policy</div>
        <div>
          We collect only the number of DAU for Boostnote and **DO NOT collect**
          any detail information such as your note content.
        </div>
        <div>
