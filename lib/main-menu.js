...
const DEFAULT_SHORTCUTS = {
  ...
  focusNote: 'Control+E',
  deleteNote: macOS? 'Control+Backspace' : 'Control+Delete',
  print: 'CommandOrControl+P',
  nextNote: 'Control+J',
  previousNote: 'Control+K',
  focusSearch: 'Control+S'
}
const menuShortcuts = config.get('menuShortcuts') || DEFAULT_SHORTCUTS
...
const file = {
  ...
  submenu: [
    {
      label: 'New Note',
      accelerator: menuShortcuts.newNote || DEFAULT_SHORTCUTS.newNote,
      click () {
    ...
    {
      label: 'Focus Note',
      accelerator: menuShortcuts.focusNote || DEFAULT_SHORTCUTS.focusNote,
      click () {
    ...
    {
      label: 'Print',
      accelerator: menuShortcuts.print || DEFAULT_SHORTCUTS.print,
      click () {
        mainWindow.webContents.send('list:isMarkdownNote')
    ...
    {
      label: 'Delete Note',
      accelerator: menuShortcuts.deleteNote || DEFAULT_SHORTCUTS.deleteNote,
      click () {
...
const view = {
  ...
  submenu: [
    ...
    {
      label: 'Next Note',
      accelerator: menuShortcuts.nextNote || DEFAULT_SHORTCUTS.nextNote,
      click () {
    ...
    {
      label: 'Previous Note',
      accelerator: menuShortcuts.previousNote || DEFAULT_SHORTCUTS.previousNote,
      click () {
    ...
    {
      label: 'Focus Search',
      accelerator: menuShortcuts.focusSearch || DEFAULT_SHORTCUTS.focusSearch,
      click () {
