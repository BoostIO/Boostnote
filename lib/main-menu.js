...
const MenuManager = require('../browser/main/lib/MenuManager')
const menuShortcuts = MenuManager.getShortcuts()
...
const file = {
  ...
  submenu: [
    {
      label: 'New Note',
      accelerator: menuShortcuts.newNote,
      click () {
    ...
    {
      label: 'Focus Note',
      accelerator: menuShortcuts.focusNote,
      click () {
    ...
    {
      label: 'Print',
      accelerator: menuShortcuts.print,
      click () {
        mainWindow.webContents.send('list:isMarkdownNote')
    ...
    {
      label: 'Delete Note',
      accelerator: menuShortcuts.deleteNote,
      click () {
...
const view = {
  ...
  submenu: [
    ...
    {
      label: 'Next Note',
      accelerator: menuShortcuts.nextNote,
      click () {
    ...
    {
      label: 'Previous Note',
      accelerator: menuShortcuts.previousNote,
      click () {
    ...
    {
      label: 'Focus Search',
      accelerator: menuShortcuts.focusSearch,
      click () {
